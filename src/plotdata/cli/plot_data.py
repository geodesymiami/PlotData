...
def create_parser():
    ...
    parser.add_argument('--ref-lalo', dest='ref_lalo', type=str, default=False, help='reference point')
...
def main(iargs):
    if len(iargs) == 1:
        ...
        cmd = 'plot_data.py GalapagosSenDT128/mintpy --plot-type=velocity --subset-lalo=-0.52:-0.28,-91.7:-91.4 --period=20200131-20220430'
        ...
        cmd = 'plot_data.py GalapagosSenDT128/mintpy --plot-type=velocity --subset-lalo=-0.52:-0.28,-91.7:-91.4'
        cmd = 'plot_data.py GalapagosSenDT128/mintpy --subset-lalo=-0.86:-0.77:-91.19:-91.07 --ref-lalo=-0.771,-91.19'
        cmd = 'GalapagosSenDT128/mintpy --subset-lalo=-0.86:-0.77:-91.19:-91.07 --ref-lalo=-0.771,-91.19'
